...
<div class="modal fade" id="add-member-modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <x-form class="modal-content" action="{{ route('website.publishers.dashboard.members.store') }}" method="POST">
...
@push('scripts')
    <script>
        function deleteMember(id) {
            warnBeforeAction(() => {
                const endpoint = '{{ route('website.publishers.dashboard.members.destroy', ':id') }}';
